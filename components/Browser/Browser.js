...
import { browserContainer, iframe, browserHeader, addressBar,  browserButton } from "./Browser.module.css";
...
const Browser = function({url = "iframe.html"}) {
    ...
    return (
        <div className={browserContainer}>
            <form className={browserHeader} onSubmit={handleSubmit}>
                ...
                <input type="text" value={_url} onChange={handleChange} className={addressBar} placeholder="https://mytoori.com" />
